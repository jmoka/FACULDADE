const db = require("../../../../database/config");  // Importa o módulo de banco de dados
const validarEmail = require("../../../../services/validarEmail");  // Importa a função de validação de email
const { Usuario_ID } = require("../../../Types/Usuarios/consultar/usuarioID");  // Importa a função para consultar o ID do usuário
const { criarHash } = require("../../../../services/hash");  // Importa a função para criar hash da senha
const perfilDefault = 3;  // Define um perfil padrão (pode ser utilizado se o perfil não for fornecido)
const Token = require("../../../../services/token");  // Importa o módulo para gerar tokens JWT
