const db = require("../../../../database/config");  // Importa o módulo de banco de dados para realizar operações no banco.
const validarEmail = require("../../../../services/validarEmail");  // Função para validar se o e-mail é válido.
const validarIdUsuarios = require("../../../../services/validarID");  // Função para validar o ID do usuário.
const validarNomeUsuarios = require("../../../../services/validarNome");  // Função para validar o nome do usuário.
