...
public class main_procedimento1 {
	...
	public static void main(String[] args) {
		...
		String nome_arqP = "dados1.dat";
		int pf = 1;
		int pj = 2;
		String nome_arqPJ = nome_arqP; // pode ate achar redundante , mas a ideia e ja deixar pronto para se o caso
		...
		pessoaPJ.persistir(nome_arqP);
		
		
		pessoaPF.obterTodos_pf_pj(1, nome_arqP);
		pessoaPF.obterTodos_pf_pj(2, nome_arqP);

		/*
		pessoaPF.excluirtodos(nome_arqP);
		pessoaPF.excluirtodos(nome_arqP);
		pessoaPJ.persistir(nome_arqP);
		pessoaPJ.persistir(nome_arqP);
